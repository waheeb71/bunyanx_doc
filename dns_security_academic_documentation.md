...
> **المنصة**: Enterprise bunyanxs NGFW v2.1  
...
تُعد **وحدة أمان DNS (DNS Security Module)** مكونًا متقدمًا للفحص العميق داخل منصة الجدار الناري المتقدم للجيل الجديد Enterprise bunyanxs NGFW. تعمل هذه الوحدة كملحق (plugin) ضمن خط معالجة الفحص متعدد المراحل، حيث تقوم باعتراض وتحليل جميع استعلامات DNS التي تعبر محيط الشبكة.
...
يمثل موديول أمان DNS **مكونًا ناضجًا ومقوى للإنتاج** ضمن منصة bunyanxs NGFW للمؤسسات. يعكس تصميمه العديد من مبادئ الهندسة البرمجية الرئيسية:
