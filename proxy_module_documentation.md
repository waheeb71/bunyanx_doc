...
3. **هجمات التوجيه الداخلي الخبيث (SSRF):** استغلال جدران الحماية كمنظومة انطلاق لاستهداف البنية التحتية الداخلية والمنافذ الحساسة غير المفتوحة للعامة.
...
│   module.py                    # الموديول الرئيسي (ProxyModule) وتكامله مع نظام المنظومة وتحديث الإعدادات الديناميكي
