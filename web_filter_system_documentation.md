...
## مشروع منصة الجدار الناري للمؤسسات (Enterprise NGFW Cybersecurity Platform)
...
تعد وحدة `web_filter` عنصراً نشطاً يتكامل مع البنية البرمجية لمنصة NGFW كالتالي:
...
5. **التكامل مع نظام التسجيل (`Logging System`)**:
   - يرسل أحداث التصفية بالتصنيف ونوع القرار إلى `logManagerApi` ليتم إرسالها إلى ملفات الأحداث المركزية وقواعد البيانات الإحصائية للـ Dashboard الرئيسي للمنصة.
...
- **القياسات المتوفرة (Metrics)**:
  - إجمالي النطاقات المستثناة وإجمالي التصنيفات المتاحة بالمنصة.
