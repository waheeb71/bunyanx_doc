  ...
  const faqs = [
    {
      ...
      a: 'منصة أمنية متقدمة للمؤسسات تجمع بين الجدار الناري الذكي (Stateful Firewall)، محرك كشف ومنع التسلل PHANTOM IDS/IPS، جدار حماية تطبيقات الويب WAF/WAAP، محرك منع تسريب البيانات DLP، والذكاء الاصطناعي التنبؤي ORACLE v3.',
    },
    {
    ...
    {
      q: 'ما المميزات الرئيسية لمحرك الذكاء الاصطناعي ORACLE v3؟',
